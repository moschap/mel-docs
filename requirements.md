...
- Maintain system resilience even under severe adverse conditions
- Fail in predictable ways
- Keep cost managable and predictable
- Use OSI approve license to mitigate future governance issues
- System policies (escalation or notification etc) should be configurable and never baked in.

## Scenarios

- Accept emergency report broadcast from a regulator, e.g when NEMA/LASEMA raises a warning
- Accept an emergency report from different users other than the entity that needs help.
